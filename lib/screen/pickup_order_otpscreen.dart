...
class Pickuporderotp extends StatefulWidget {

  late String countrycode;
  late String mobile;

  Pickuporderotp({required this.mobile, required this.countrycode});
  @override
  _PickuporderotpPageState createState() => _PickuporderotpPageState();
}

class _PickuporderotpPageState extends State<Pickuporderotp> {
