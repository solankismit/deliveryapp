import 'dart:io';
import 'package:delivery_boy/screen/new_password.dart';
...
class VerificationScreenn extends StatefulWidget {

  String countrycode;
  String mobile;

  VerificationScreenn({required this.mobile, required this.countrycode});
  @override
  _VerificationScreennPageState createState() => _VerificationScreennPageState();
}

class _VerificationScreennPageState extends State<VerificationScreenn> {
